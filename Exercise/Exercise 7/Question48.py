# Question 5 :-Two customer ID sets are given. The first one tells you whether a person clicked on the banner ad. Second, whether the person purchased the product:
...
is_clicked = {'9001', '9002', '9005'}
is_bought = {'9002', '9004', '9005'}
diiiifffff = is_clicked.intersection(is_bought)
print(diiiifffff)